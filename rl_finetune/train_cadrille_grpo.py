...
def main(config: TrainConfig):
    ...
    eval_data_deepcad = RealDatasetMM(path=f'/home/users/zhemchuzhnikov/jovyan/tarasov/data/deepcad_fusion_train', file_name='test.pkl', n_points=256, size=1000)
    eval_data_fusion = RealDatasetMM(path=f'/home/users/zhemchuzhnikov/jovyan/tarasov/data/fusion360_test', file_name='test.pkl', n_points=256, size=1000)
    train_data = RealDatasetMM(path=f'/home/users/zhemchuzhnikov/jovyan/tarasov/data/deepcad_fusion_train', file_name=config.train_file, n_points=256, mode=config.train_mode, noise_scale_pc=0.01, size=config.train_size)
